...
import { Toast, Notify, NotifyType } from 'vant';
...
const transform: AxiosTransform = {
  ...
  responseInterceptorsCatch: (axiosInstance: AxiosResponse, error: any) => {
    ...
    let errMessage = '';
    let errorShowType: NotifyType = 'danger';
    ...
    if (errMessage) {
      ...
      if (errorMessageMode === 'modal') {
        Notify({ type: errorShowType, message: 'errMessage' });
